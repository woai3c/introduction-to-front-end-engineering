...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f90764cefe744fbaad5eddf1de0bb08c~tplv-k3u1fbpfcp-watermark.image)

选择 `File` -> `Preference`-> `Settings`（如果装了中文插件包应该是 文件 -> 选项 -> 设置），搜索 eslint，点击 `Edit in setting.json`。

![在这里插入图片描述](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/359dc995b05e423eb5e2c5db4925f71c~tplv-k3u1fbpfcp-zoom-1.image)
...
![](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f1bd13cb84a34d78aaec9f1e98c17790~tplv-k3u1fbpfcp-zoom-1.image)
...
npm i -D tslint
```
![在这里插入图片描述](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/61c0201f963d4e9d9bbe875053fbd054~tplv-k3u1fbpfcp-zoom-1.image)
...
![在这里插入图片描述](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/118eeef0acee46769303953ad8b3e6f1~tplv-k3u1fbpfcp-zoom-1.image)

因为之前已经设置过 ESlint 的格式化规则了，所以 Vue 文件只需要格式化 HTML 和 CSS 中的代码，不需要格式化 JavaScript 代码，所以我们需要禁止 vetur 格式化 JavaScript 代码：

![在这里插入图片描述](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/fbd3c4b8ce464e4ba099e5df8ce870dc~tplv-k3u1fbpfcp-zoom-1.image)
...
![在这里插入图片描述](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/595491d52c354c68b662ee902e8a0b4e~tplv-k3u1fbpfcp-zoom-1.image)

然后就可以看到效果了。

![在这里插入图片描述](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9b4d8e17b0f2488c8379541544147ef3~tplv-k3u1fbpfcp-zoom-1.image)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1e4b48d94aa640fbbebbadaa0386b97c~tplv-k3u1fbpfcp-watermark.image)
